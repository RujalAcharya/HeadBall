...
namespace HeadBall {
    ...
    void PausedState::init () {
        ...
        // this->_aboutBtn.setOrigin(_aboutBtn.getGlobalBounds( ).width / 2, _aboutBtn.getGlobalBounds( ).height / 2);
        ...
        this->_exitBtn.setPosition(WINDOW_WIDTH / 2, WINDOW_HEIGHT / 2 + 125);
